...
class _UsedCarMainScreenState extends State<UsedCarMainScreen>
  ...
  Widget _buildAxisCards(BuildContext context) {
    return Padding(
          ...
          child: Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.sell_rounded, color: Color(0xFF4FC3F7), size: 22),
              ),
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                    ...
                    child: const Text('헤이딜러형', style: TextStyle(color: Color(0xFF4FC3F7), fontSize: 10, fontWeight: FontWeight.w700)),
                  ),
                  const SizedBox(width: 6),
                  const Text('내 차 팔기', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w700)),
                ]),
                const SizedBox(height: 3),
                const Text('차량번호 입력 → 딜러 역경매 → 최고가 매입', style: TextStyle(color: Color(0xFF8899AA), fontSize: 11)),
              ])),
              const Icon(Icons.chevron_right_rounded, color: Color(0xFF4FC3F7), size: 20),
            ]),
          ),
        ),
        // 2. 중고차 찾기
          ...
          child: Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.search_rounded, color: Color(0xFF10B981), size: 22),
              ),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                    ...
                    child: const Text('엔카형', style: TextStyle(color: Color(0xFF10B981), fontSize: 10, fontWeight: FontWeight.w700)),
                  ),
                  const SizedBox(width: 6),
                  const Text('중고차 찾기', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w700)),
                ]),
                const SizedBox(height: 3),
                const Text('제조사→모델→연식→연료 세부 조건 검색', style: TextStyle(color: Color(0xFF8899AA), fontSize: 11)),
              ])),
              const Icon(Icons.chevron_right_rounded, color: Color(0xFF10B981), size: 20),
            ]),
          ),
        ),
        // 3. 견적 연결
          ...
          child: Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.handshake_rounded, color: Color(0xFF8B5CF6), size: 22),
              ),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                    ...
                    child: const Text('KAA협회형', style: TextStyle(color: Color(0xFF8B5CF6), fontSize: 10, fontWeight: FontWeight.w700)),
                  ),
                  const SizedBox(width: 6),
                  const Text('견적 연결', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w700)),
                ]),
                const SizedBox(height: 3),
                const Text('KAA 인증 딜러가 직접 견적·방문 서비스', style: TextStyle(color: Color(0xFF8899AA), fontSize: 11)),
              ])),
              const Icon(Icons.chevron_right_rounded, color: Color(0xFF8B5CF6), size: 20),
            ]),
          ),
        ),
      ]),

...
const Map<String, Map<String, String>> _plateDB = {
  '123가4567': {'model': '현대 그랜저 IG 3.0', 'year': '2019년식', 'regDate': '2019-03-15'},
  '456나7890': {'model': 'BMW 320i (G20)', 'year': '2020년식', 'regDate': '2020-07-22'},
  '789다1234': {'model': '기아 K5 DL3 2.0', 'year': '2021년식', 'regDate': '2021-01-08'},
  '111라2222': {'model': '현대 아반떼 CN7', 'year': '2022년식', 'regDate': '2022-05-30'},
  '333마4444': {'model': '테슬라 모델3 LR', 'year': '2023년식', 'regDate': '2023-02-14'},
  '555바6666': {'model': '벤츠 E220d W213', 'year': '2022년식', 'regDate': '2022-11-01'},
};
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [_green.withOpacity(0.12), _accent.withOpacity(0.06)],
              ),
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.check_circle_outline, color: _green, size: 22),
              ),
              const SizedBox(width: 12),
              Expanded(child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Row(children: [
                    ...
                    _infoChip('등록 ${_foundRegDate ?? ''}', _green),
                  ]),
                ],
              )),
              GestureDetector(
